...
export const translations = {
  de: {
    ...
    pdfDocTypeValue: 'Eigenbeleg – Steuerliche Aufschlüsselung Apple Financial Report',
    pdfSource: 'Quelle',
  ...
  en: {
    ...
    pdfDocTypeValue: 'Eigenbeleg – Tax breakdown Apple Financial Report',
    pdfSource: 'Source',
    pdfSourceValue: 'Apple Distribution International Ltd., Cork, Ireland',
    pdfCreated: 'Created',
    pdfPage: 'Page',
